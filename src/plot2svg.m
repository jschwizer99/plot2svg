            ...
            if ~strcmp(marker, 'none')
                for q = 1:size(faces,2)
                    ...
                    switch marker
                        ...
                        case '+',group=group+1;patch2svg(fid,group,axpos,xmarker'*ones(1,5)+[-1 1 NaN 0 0]*markersize,ymarker'*ones(1,5)+[0 0 NaN -1 1]*markersize,markeredgecolorname,'-',linewidth,markeredgecolorname, 1, 1, false);
                        case '*',group=group+1;patch2svg(fid,group,axpos,xmarker'*ones(1,11)+[-1 1 NaN 0 0 NaN -0.7 0.7 NaN -0.7 0.7]*markersize,ymarker'*ones(1,11)+[0 0 NaN -1 1 NaN 0.7 -0.7 NaN -0.7 0.7]*markersize,markeredgecolorname,'-',linewidth,markeredgecolorname, 1, 1, false);
                        case 'x',group=group+1;patch2svg(fid,group,axpos,xmarker'*ones(1,5)+[-0.7 0.7 NaN -0.7 0.7]*markersize,ymarker'*ones(1,5)+[0.7 -0.7 NaN -0.7 0.7]*markersize,markeredgecolorname,'-',linewidth,markeredgecolorname, 1, 1, false);
                            %% Octave keeps s, d, p and h in the HandleGraphics object, for the square, diamond, pentagram, and hexagram markers, respectively -- Jakob Malm
                        case {'square', 's'},group=group+1;patch2svg(fid,group,axpos,xmarker'*ones(1,5)+[-1 -1 1 1 -1]*markersize,ymarker'*ones(1,5)+[-1 1 1 -1 -1]*markersize,markerfacecolorname,'-',linewidth,markeredgecolorname, 1, 1, true);
                        case {'diamond', 'd'},group=group+1;patch2svg(fid,group,axpos,xmarker'*ones(1,5)+[-0.7071 0 0.7071 0 -0.7071]*markersize,ymarker'*ones(1,5)+[0 1 0 -1 0]*markersize,markerfacecolorname,'-',linewidth,markeredgecolorname, 1, 1, true);
                        case {'pentagram', 'p'},group=group+1;patch2svg(fid,group,axpos,...
                                xmarker'*ones(1,11)+[0 0.1180 0.5 0.1910 0.3090 0 -0.3090 -0.1910 -0.5 -0.1180 0]*1.3*markersize,...
                                ymarker'*ones(1,11)+[-0.5257 -0.1625 -0.1625 0.0621 0.4253 0.2008 0.4253 0.0621 -0.1625 -0.1625 -0.5257]*1.3*markersize,markerfacecolorname,'-',linewidth,markeredgecolorname, 1, 1, true);
                        case {'hexagram', 'h'},group=group+1;patch2svg(fid,group,axpos,...
                                xmarker'*ones(1,13)+[0 0.2309 0.6928 0.4619 0.6928 0.2309 0 -0.2309 -0.6928 -0.4619 -0.6928 -0.2309 0]*1*markersize,...
                                ymarker'*ones(1,13)+[0.8 0.4 0.4 0 -0.4 -0.4 -0.8 -0.4 -0.4 0 0.4 0.4 0.8]*1*markersize,markerfacecolorname,'-',linewidth,markeredgecolorname, 1, 1, true);
                        case '^',group=group+1;patch2svg(fid,group,axpos,xmarker'*ones(1,4)+[-1 1 0 -1]*markersize,ymarker'*ones(1,4)+[0.577 0.577 -1.155 0.577]*markersize,markerfacecolorname,'-',linewidth,markeredgecolorname, 1, 1, true);
                        case 'v',group=group+1;patch2svg(fid,group,axpos,xmarker'*ones(1,4)+[-1 1 0 -1]*markersize,ymarker'*ones(1,4)+[-0.577 -0.577 1.155 -0.577]*markersize,markerfacecolorname,'-',linewidth,markeredgecolorname, 1, 1, true);
                        case '<',group=group+1;patch2svg(fid,group,axpos,xmarker'*ones(1,4)+[0.577 0.577 -1.155 0.577]*markersize,ymarker'*ones(1,4)+[-1 1 0 -1]*markersize,markerfacecolorname,'-',linewidth,markeredgecolorname, 1, 1, true);
                        case '>',group=group+1;patch2svg(fid,group,axpos,xmarker'*ones(1,4)+[-0.577 -0.577 1.155 -0.577]*markersize,ymarker'*ones(1,4)+[-1 1 0 -1]*markersize,markerfacecolorname,'-',linewidth,markeredgecolorname, 1, 1, true);
                    end
                    % close the marker group
                    fprintf(fid,'</g>\n');
